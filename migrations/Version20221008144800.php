...
final class Version20221008144800 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE holiday_request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author INTEGER NOT NULL, status VARCHAR(255) NOT NULL, resolved_by INTEGER NULL, request_created_at DATETIME NOT NULL, vacation_start_date DATETIME NOT NULL, vacation_end_date DATETIME NOT NULL)');
        $this->addSql('CREATE INDEX status_index ON holiday_request (status)');
